    ...
    void getConnection()
{
    ...
    void addRowToTable(Date d,Time t)
    {
        DefaultTableModel model=(DefaultTableModel)table.getModel();
                model.addRow(new Object[]{d,t});
    }
    void findData(String s)
    {
    try {
        smt=con.createStatement();
        String query="select calltime,calldate from recent where contact_no='"+s+"'";
        rs=smt.executeQuery(query);
        while(rs.next())
        {
            java.sql.Date d=rs.getDate("calldate");
            java.sql.Time t=rs.getTime("calltime");
            addRowToTable(d,t);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(20, 40, 400, 250);
